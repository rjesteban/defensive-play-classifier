...
zonedefs = {"""
            "0021500149": [364, 375, 381, 392, 404],
...
mandefs = {"""
            "0021500149" : [2, 4, 7, 15, 32, 33, 40, 41, 52, 62, 67, 72, 82,
...
for gameid in sorted(mandefs.keys()):
    data = json.load(open('data/sportvu/' + gameid + '.json'))
    for eventid in mandefs[gameid]:
        try:
            visualize(data, eventid, -1)
        except Exception as e:
            print str(e) + " " + str(gameid) + " " + str(eventid)
    for eventid in zonedefs[gameid]:
        try:
            visualize(data, eventid, 1)
        except Exception as e:
            print str(e) + " " + str(gameid) + " " + str(eventid)
